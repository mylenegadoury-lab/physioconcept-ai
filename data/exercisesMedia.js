...
export const exercisesDatabase = {
  ...
  lumbar: [
    ...
    },
    {
      ...
      dosage: "3 séries de 15 répétitions, 3 fois par semaine",
      difficulty: "Débutant",
      safetyTips: "Activez les fessiers, pas les lombaires",
      imagePrompt: "Woman performing glute bridge exercise, hips raised",
      videoKeywords: ["glute bridge", "hip extension", "butt exercises"],
      progression: "Pont unilatéral",
      benefits: "Renforce les fessiers, soutient le bas du dos",
    },
  ],
